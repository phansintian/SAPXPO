...
namespace SAPXPO.Web {
    // For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.Web.WebApplication
    public partial class SAPXPOAspNetApplication : WebApplication {
        private DevExpress.ExpressApp.SystemModule.SystemModule module1;
        private DevExpress.ExpressApp.Web.SystemModule.SystemAspNetModule module2;
        private SAPXPO.Module.SAPXPOModule module3;
        private SAPXPO.Module.Web.SAPXPOAspNetModule module4;
        ...
        public SAPXPOAspNetApplication() {
            InitializeComponent();
        }
        ...
        private void SAPXPOAspNetApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
        ...
        private void InitializeComponent() {
            ...
            this.module4 = new SAPXPO.Module.Web.SAPXPOAspNetModule();
            ...
            this.DatabaseVersionMismatch += new System.EventHandler<DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs>(this.SAPXPOAspNetApplication_DatabaseVersionMismatch);
